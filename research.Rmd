...
* Tsai, Yung-Yu, Han, Hsing-Wen, Lo, Kuang-Ta & Yang, Tzu-Ting. The effect of financial resources on fertility: Evidence from administrative data on lottery winners. _(Submitted)_ [<a href = "https://ssrn.com/abstract=4300448" target="_blank">Working Paper</a>]
<details> <summary><font size=2>Abstract</font size></summary>
...
* Tsai, Yung-Yu, Huang, Po-Chun & Yang, Tzu-Ting. Long-term effects of job displacement on earnings and mental health: A research note using population-based administrative data. _(Submitted)_

* Pham, Trang & Tsai, Yung-Yu. The roles of faculty hiring and retention in shaping faculty diversity in U.S. higher education institutions---retrospect and prospect from 2001 to 2035. _(Submitted)_
