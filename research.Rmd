...
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> A regular property reassessment, aiming to align assessed values with fair market prices, is an important tool for ensuring tax equity. However, the reassessment itself might unintentionally affect the housing market. This paper examines the impact of property reassessment on housing prices and discusses two mechanisms with opposite predicted directions: the capitalization effect (reassessment leads to drops in housing prices) and the anchoring effect (reassessment causes increases in housing prices). The paper utilizes county-wide reassessments over time in the state of Pennsylvania and employs a staggered difference-in-differences (DID) design to examine the causal effect of property reassessment. Additionally, the study uses both between- and within-county variations and combines DID with a two-stage least squares (2SLS) approach to decompose the two channels. The results suggest that the anchoring effect (positive) outweighs the capitalization effect (negative). On average, property reassessment increases housing values in counties. Furthermore, regions that were most underestimated in the pre-reform period experienced the most potent effect on boosting of housing values. The findings highlight that while property reassessment improves tax progressivity, it rewards wealthy individuals with more capital gains, which contradicts the goal of wealth equality. </font size></div>
</details>
