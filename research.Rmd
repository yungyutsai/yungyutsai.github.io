...
* Tsai, Yung-Yu. Non-profit colleges' responses to the net investment income tax---Evidence from the Tax Cuts and Jobs Act.
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> The 2017 Tax Cuts and Jobss Act introduced a net investment income tax targeting large and wealthy non-profit colleges with the goal of enhancing tax equity and wealth distribution within higher education institutions. However, this paper reveals an unintended consequence of the policy—colleges strategically increasing student enrollment to circumvent the tax threshold based on population. While this policy loophole results in a government revenue loss, it prompts colleges to provide more education opportunities. Conversely, colleges subject to the tax respond by elevating tuition levels to offset the financial burden, disproportionately affecting the enrollment of historically underrepresented racial groups. This fiscal response suggests that taxation designed to improve tax equity may inadvertently hinder equity in access to higher education. The findings prompt a reevaluation of the policy’s impact and advocate for potential adjustments to foster both taxation and educational equity. </font size></div>
</details>
