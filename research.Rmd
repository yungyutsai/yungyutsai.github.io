...
* A Study on the Effectiveness Evaluation of the Social Safety Net Program and the Establishment of Medium- and Long-Term Monitoring Indicators 衛生福利部社會及家庭署強化社會安全網計畫成效評估及建立中長期觀察評估指標案 _Commissioned Research Project, Ministry of Health and Welfare 衛生福利部委託研究計畫_ (with Don-Yun Chen 陳敦源, Guang-Xu Wang 王光旭, Yi-Chun Liu 劉宜君, Chien-Chia Liu 劉千嘉, Yang-Chung Chen 陳揚中, Yung-Yu Tsai 蔡咏諭)

------

### Peer-reviewed Publications

* Tsai, Yung-Yu, Han, Hsing-Wen, Lo, Kuang-Ta & Yang, Tzu-Ting. The effect of financial resources on fertility: Evidence from administrative data on lottery winners. _Journal of Labor Economics, forthcoming_. (accepted, in-press). [<a href = "https://doi.org/10.7910/DVN/SE6KFO" target="_blank">Data and Codes</a>]
...
* Tsai, Yung-Yu. Colleges' responses to the Net Investment Income Tax and the impact on education opportunities. _(Revision Request from Educational Evaluation and Policy Analysis)_ 
<details> <summary><font size=2>Abstract</font size></summary>
...
* Tsai, Yung-Yu, Fu, Kai-Jo, & Keiser, Lael. The relationship between same-race subordinates and federal supervisors’ job satisfaction. _(Revision Request from Public Personnel Management)_ 
<details> <summary><font size=2>Abstract</font size></summary>
...
* Tsai, Yung-Yu. The equity-efficiency trade-off: Impact of Taiwan’s high school detracking reform on school stratification, educational access, and student performance. _(Revision Request from from Journal of Social Sciences and Philosophy 人文及社會科學集刊)_ <details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> This study examines Taiwan's 2014 exam-free high school admission reform, which reduced ability tracking while maintaining the general/vocational dual-track system. Using difference-in-differences analysis comparing high school students (exposed) and middle school students (not exposed), I find that the reform increased within-school heterogeneity by 0.088 standard deviations, closing approximately 40\% of the stratification gap between full tracking and non-tracking systems. The reform improved equity by enhancing low-performing students' access to higher-quality schools, qualified teachers, and high-achieving peers. However, this comes at a cost: the detracking reform results in a 0.171 standard deviation decrease in average student performance, with negative effects distributed uniformly across the entire achievement distribution. These findings reveal a fundamental equity-efficiency trade-off, suggesting detracking policies improve educational access for disadvantaged students but may reduce overall academic achievement. </font size></div>
</details>

<div style="line-height:50%;"><br></div>

* Hung, Wan-Ju \& Tsai, Yung-Yu. Linking government contracting programs for social goals to public employees’ job satisfaction: Findings from the Federal Small Disadvantaged Business Contracting Program. _(Under Review)_ <details> <summary><font size=2>Abstract</font size></summary>
