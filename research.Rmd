...
* Tsai, Yung-Yu. Nonprofits' tax avoidance and shifting behaviors---Insights from the net investment income tax on nonprofit colleges _(Submitted)_ [<a href = "papers/endowment_tax.pdf" target="_blank">Working Paper</a>]
...
* Tsai, Yung-Yu, Huang, Po-Chun & Yang, Tzu-Ting (2024). Long-term effects of job displacement on earnings and mental health: Evidence from population-wide administrative data. _Economics Letters, Forthcoming_
<details> <summary><font size=2>Abstract</font size></summary>
...
* Tsai, Yung-Yu. The impact of property reassessment on housing values---Decomposing the capitalization and anchoring effects.
<details> <summary><font size=2>Abstract</font size></summary>
