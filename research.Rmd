...
* Tsai, Yung-Yu, Fu, Kai-Jo, & Keiser, Lael (2026). Racially divergent patterns in the relationship between same-race subordinates and federal supervisors’ job satisfaction. _Public Personnel Management, forthcoming_ (accepted, in-press). [<a href = "papers/BurdensOfSupervisors.pdf" target="_blank">Accepted Manuscript</a>] [<a href = "https://github.com/yungyutsai/Burden_of_Representation" target="_blank">Data and Codes</a>]
