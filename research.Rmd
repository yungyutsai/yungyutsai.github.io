...
* Pham, Trang & Tsai, Yung-Yu. The roles of faculty hiring and retention in shaping faculty diversity in US higher education institutions---retrospect and prospect from 2001 to 2035. _(Revision Request)_
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> US higher education is witnessing rapid changes in the racial demographics of student and faculty populations. While racial representation on American campuses is increasing, faculty diversity lags behind student diversity regarding race and ethnicity. Using data from the Integrated Postsecondary Education Data System (IPEDS) from 2001 to 2021, this study captures the racial dynamics of student and faculty populations in different higher education institution types. The paper, then, applies the concept of stock-and-flow to study the contributions of diversity inflow (faculty hiring) and diversity outflow (faculty turnover) on faculty diversity stock. Five simulations are constructed to predict faculty diversity changes and future trends sector-wide. Our policy recommendation calls for balanced efforts in both the retention and hiring of faculty to diversify the faculty workforce. </font size></div>
</details>


<div style="line-height:50%;"><br></div>

* Tsai, Yung-Yu, Huang, Po-Chun & Yang, Tzu-Ting. Long-term effects of job displacement on earnings and mental health: Evidence from population-wide administrative data. _(Revision Request)_
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> Utilizing administrative data encompassing the entire population of Taiwan, in this research note we investigate the long-term effects of job displacement on earnings and mental health. Focusing on job loss resulting from mass layoffs, our estimates suggest displaced workers experienced a 67% earning loss in the year following a layoff. Even after ten years, earnings do not fully recover. Displaced workers also experience long term
deterioration in mental health, particularly related to stress, with a 16\% increase in cumulative outpatient visits for mental health issues and a 57\% increase in cumulative medical costs for mental illness in the decade post-displacement. The negative impact on mental health is more pronounced among workers with lower earnings, men, and older individuals. </font size></div>
</details>

<div style="line-height:50%;"><br></div>

* Tsai, Yung-Yu, Han, Hsing-Wen, Lo, Kuang-Ta & Yang, Tzu-Ting. The effect of financial resources on fertility: Evidence from administrative data on lottery winners. [<a href = "https://ssrn.com/abstract=4300448" target="_blank">Working Paper</a>]
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> This paper utilizes wealth shocks from winning lottery prizes to examine the causal effect of financial resources on fertility. We utilize extensive panels of administrative data encompassing over 0.4 million lottery winners in Taiwan and implement a triple-differences design. Our analyses reveal that a substantial lottery win can significantly increase fertility and the implied wealth elasticity of fertility is around 0.06. Moreover, the primary channel through which fertility increases is by prompting first births among previously childless individuals. Finally, our analysis reveals approximately 33\% of the total fertility effect stems from increased marriage rates following lottery wins. </font size></div>
</details>
...
<details> <summary><font size=2>Abstract</font size></summary>
> <div style="line-height:100%;"><font size=2> A select few non-profit colleges in the US have managed enormous endowments that annually generate considerable capital gains, which were historically exempted from taxation. In the 2017 Tax Cut and Job Act, the government imposed a new net investment income tax on large and wealthy non-profit colleges. The policy aims to improve tax equity and wealth distribution across higher education institutions. However, as the policy has a tax threshold based on student population, this paper finds that colleges manipulate student enrollment to avoid the tax. Besides, colleges subject to the tax respond to the tax cost by increasing the tuition level to shift the burden to their customers (students). This paper finds that colleges' behavioral and fiscal responses further reduce the college enrollment of students of historically underrepresented racial groups. The result implies that the net investment income tax aiming to improve tax equity might unintentionally impede equity in access to higher education. </font size></div>
</details>

<div style="line-height:50%;"><br></div>

* Tsai, Yung-Yu. The impact of property reassessment on housing values---Decompose the capitalization and anchoring effects.
<details> <summary><font size=2>Abstract</font size></summary>
...
* Tsai, Yung-Yu & Yang, Tzu-Ting. The impact of on-campus residence on students' short and long-term academic outcomes---Evidence from boundary discontinuity design.
<details> <summary><font size=2>Abstract</font size></summary>
